...
hostname = 'redis-12047.c62.us-east-1-4.ec2.cloud.redislabs.com'
portnumber = 12047
password = 'PlO8o5XzyPtuxX1kBwITkuzARxdUTNph'
...
def retrive_data(name):
    ...
    retrive_df[['Name', 'Role']] = retrive_df['name_role'].str.split('@', expand=True, n=1)
